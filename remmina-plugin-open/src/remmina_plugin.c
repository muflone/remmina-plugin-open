...
{
  remmina_plugin_service->log_printf("[%s] remmina_plugin_open_init\n", PLUGIN_NAME);
}

static gboolean remmina_plugin_open_open_connection(RemminaProtocolWidget *gp)
{
  remmina_plugin_service->log_printf("[%s] remmina_plugin_open_open_connection\n", PLUGIN_NAME);
...
{
  remmina_plugin_service->log_printf("[%s] remmina_plugin_open_close_connection\n", PLUGIN_NAME);
